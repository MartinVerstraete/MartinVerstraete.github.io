...
var m = [60, 0, 10, 0],
    ...
    var colors = {
      "World":[0,0,0],
      "Europe": [0,0,254],
      "North America": [0,254,0],
      "South America": [254,0,0],
      "Africa": [254,230,0],
      "Asia": [0,230,254],
      "Central America": [120,130,60],
      "Oceania": [200,130,230]
...
function init() {
  ...
  changeData('./data/10_14/data_10_14.csv');
...
function changeData(val) {
  ...
  if (val == './data/95_99/data_95_99.csv'){
    document.getElementById("chartheader").innerHTML = "Visualization from 1995 to 1999";
  }
  else if (val == './data/00_04/data_00_04.csv'){
    document.getElementById("chartheader").innerHTML = "Visualization from 2000 to 2004";
  }
  else if (val == './data/05_09/data_05_09.csv'){
    document.getElementById("chartheader").innerHTML = "Visualization from 2005 to 2009";
  }
  else {
        document.getElementById("chartheader").innerHTML = "Visualization from 2010 to 2014";
  }
